...
export const ingredients: Ingredient[] = [
  ...
  // ---- botanicals ----------------------------------------------------------
  {
    ...
    what: "Indian madder. Works with neem to clear blemishes, reduce acne and improve skin texture.",
  },
  {
    name: "Neem",
    group: "botanicals",
    inci: ["Azadirachta Indica"],
    what: "Long used for its healing properties, and paired with Manjistha for clarity.",
  },
  {
    name: "Brahmi",
    group: "botanicals",
  ...
  },
  {
    ...
    what: "Indian gooseberry, antioxidant-rich, and one of the oils named on the Elixir Radiance pack.",
  },
  {
    name: "Ashwagandha",
    group: "botanicals",
  ...
  },
  {
    ...
    what: "Holy basil, in the detox mask.",
  },
  {
    name: "Green Tea",
    group: "botanicals",
  ...
  },
  {
    ...
    what: "Named on the Elixir Radiance pack, with macadamia, Amla and Bhringraj.",
  },
  {
    name: "Bhringraj",
    group: "oils",
