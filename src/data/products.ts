...
export const products: Product[] = [
  {
    ...
    priceUsd: 24,
    keyActives: [
      "Hydrolyzed Collagen (marine origin)",
      "Hydrolyzed Elastin (marine origin)",
      "Hyaluronic Acid",
    ],
